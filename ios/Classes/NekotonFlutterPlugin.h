...
void nt_transport_get_signature_id(long long result_port, void *transport, int transport_type);

void nt_transport_get_network_id(long long result_port, void *transport, int transport_type);
